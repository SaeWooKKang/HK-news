...
function newsDetail() {
  ...
  var newsContent = getData(NEWS_CONTENT.replace('@id', id));
  var template = "\n    <h1>{{__content_title__}}</h1>\n    <div>".concat(newsContent.content, "</div>\n\n    <a href=\"#/page/{{__current_page__}}\">\uB3CC\uC544\uAC00\uAE30</a>\n\n    <div>\n      {{__comments__}}\n    </div>\n  ");

  function makeComment(comments) {
    var commentString = [];

    for (var _i = 0; _i < comments.length; _i++) {
      commentString.push("\n        <div>---------------------------------------------------------</div>\n            <div".concat(comments[_i].content, "</div>\n            <div>user : ").concat(comments[_i].user, " / ").concat(comments[_i].time_ago, "</div>\n        </div>\n      "));
    }
...
if ((!parent || !parent.isParcelRequire) && typeof WebSocket !== 'undefined') {
  ...
  var ws = new WebSocket(protocol + '://' + hostname + ':' + "10308" + '/');
